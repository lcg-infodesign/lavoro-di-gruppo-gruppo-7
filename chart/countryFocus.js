// classe creata per gestione  visualizzazione di dettaglio (focus)
class countryFocus {
	...
	// disegno elementi relativi ai dati presi dal dataset da mappare
	drawSingleFocus() {
		let spacing = 0.2 * this.width;
		let totalWidth = (this.countryData.length - 1) * spacing;
		let pX = (this.width - totalWidth) / 2;
